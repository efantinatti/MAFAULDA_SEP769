...
if choice == 1:
    ...
    np.savetxt("D:/SEP769_DeepLearning/jul20data/train_data.txt", train_reshaped)
    np.savetxt("D:/SEP769_DeepLearning/jul20data/test_data.txt", test_reshaped)
    

    np.savetxt("D:/SEP769_DeepLearning/jul20data/train_label.txt", train_label)
    np.savetxt("D:/SEP769_DeepLearning/jul20data/test_label.txt", test_label)
